...
class KukaGymEnv(gym.Env):
  ...
  def getExtendedObservation(self):
    ...
    # print("observation[1]:"+str(self._observation))
    ...
    # print("blockPosInGripper:"+str(blockPosInGripper))
    # print("blockEulerInGripper:"+str(blockEulerInGripper))
    # print("observation:"+str(self._observation[8]))
  ...
  def step2(self, action):
    ...
    # print("blockOrn:"+str(blockOrn))
    # print(done)

    return np.array(self._observation), reward, done, blockPos[2]
  ...
  def _termination(self):
    ...
    # print("closestPoints:" + str(closestPoints))
    ...
    if (len(closestPoints)):  #(actualEndEffectorPos[2] <= -0.43):
      ...
      for i in range(1000):
        ...
        state = p.getLinkState(self._kuka.kukaUid, self._kuka.kukaEndEffectorIndex)
        actualEndEffectorPos = state[0]
        # print("actualEndEffectorPos:"+str(actualEndEffectorPos))
